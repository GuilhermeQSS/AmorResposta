...
function AdminEntidadesFuncionariosCadastrar() {
    ...
    async function fetchCadastrarFuncionario() {
        ...
        try {
            ...
            if (response.ok) {
                navigate("/admin/entidades/funcionarios/tabela");
            } else {
    ...
    return (
        <>
            ...
            <main>
                <Styled.BackBtn>
                    <Link to="/admin/entidades/funcionarios/tabela">
                        <div>Voltar</div>
                    </Link>
                </Styled.BackBtn>
...
export default AdminEntidadesFuncionariosCadastrar;